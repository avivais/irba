...
import { Users, CalendarDays, FileUp, Settings, ClipboardList, Banknote, MessageCircle, BarChart2, Trophy } from "lucide-react";
    ...
    <div className="flex flex-1 flex-col px-4 pb-10 pt-6 sm:px-6">
      ...
      <nav className="mx-auto mt-8 grid w-full max-w-2xl md:max-w-4xl grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <div>
            <p className="font-semibold text-zinc-900 dark:text-zinc-100">תחרויות</p>
            <p className="mt-0.5 text-sm text-zinc-500 dark:text-zinc-400">
              לוחות הישגים ואתגרים
            </p>
          </div>
        </Link>
      </nav>
